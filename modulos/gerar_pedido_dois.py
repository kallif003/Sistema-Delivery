def pedido(cursor, banco10, id_pedido, data, data2, desc, din, troco, cartao, voucher, pix, obs, valor, dados, hora):
    ...
    if adc != ():
        for i in range(len(adc)):
            ...
            insert = (str(adc[i][1]), str(adc[i][2]), str(adc[i][3]), str(adc[i][4]), str(adc[i][5]), str(adc[i][6]),
    ...
    arquivo.write('Endereco:' + ' ' + str(dados[0][4]) + '   ' + 'Numero:' + ' ' + str(dados[0][5]) + '\n')
    ...
    if metade1 != ():
        for i, j in zip(metade1, metade2):
            arquivo.write('-' * 33 + '\n')
            arquivo.write(str(j[5]) + 'x' + ' ' + 'Pizza' + ' ' + str(i[1]) + ' ' + 'Pedacos' + ' ' + 'R$:' + str(
                j[6]) + '\n\n\n')
            arquivo.write('Sabor:' + '\n')
    ...
    if terco1 != ():
        for i, j, k in zip(terco1, terco2, terco3):
            arquivo.write('-' * 33 + '\n')
            arquivo.write(str(k[5]) + 'x' + ' ' + 'Pizza' + ' ' + str(i[1]) + ' ' + 'Pedacos' + ' ' + 'R$:' + str(
                k[6]) + '\n\n\n')
            arquivo.write('Sabor:' + '\n')
    ...
    if quarto1 != ():
        for i, j, k, l in zip(quarto1, quarto2, quarto3, quarto4):
            arquivo.write('-' * 33 + '\n')
            arquivo.write(str(l[5]) + 'x' + ' ' + 'Pizza' + ' ' + str(i[1]) + ' ' + 'Pedacos' + ' ' + 'R$:' + str(
                l[6]) + '\n\n\n')
            arquivo.write('Sabor:' + '\n')
    ...
    if outros != ():
        for i in range(len(outros)):
            arquivo.write('-' * 33 + '\n')
            arquivo.write(
                str(outros[i][4]) + 'x' + ' ' + str(outros[i][0]) + ' ' + 'R$:' + str(outros[i][5]) + '\n\n\n')
